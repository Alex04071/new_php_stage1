...
if($user['role'] === 'admin'){
    ...
    if(!$date_user[0]){
        ...
        $_SESSION['id'] = $_GET['id'];
        $result = has_image($date_user[0]['id'], $date_user[0]['imgProfil']);
        if($result){
            $image = $date_user[0]['imgProfil'];
        }else{
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="edit_user_avatar.php" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button class="btn btn-warning" name="submit" value="download_avatar">Загрузить</button>
                                </div>
                            </div>
                        </div>
                    </div>
