...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="edit_set_status.php" method="post">
            <div class="row">
                <div class="col-xl-6">
                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button class="btn btn-warning" type="submit" name="set_status" value="sent_status">Установить статус</button>
                                    </div>
                                </div>
                            </div>
                        </div>
